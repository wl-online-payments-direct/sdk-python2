...
class CreateHostedTokenizationRequest(DataObject):
    ...
    def ask_consumer_consent(self, value):
        self.__ask_consumer_consent = value

    @property
    def credit_card_specific_input(self):
        """
    ...
    def credit_card_specific_input(self, value):
    ...
    def page_customization(self, value):
