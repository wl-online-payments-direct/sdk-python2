...
class RedirectPaymentMethodSpecificOutput(DataObject):
    ...
    def customer_bank_account(self, value):
    ...
    @property
    def payment_product3203_specific_output(self):
        """
    ...
    def payment_product3203_specific_output(self, value):
    ...
    def payment_product5402_specific_output(self, value):
        self.__payment_product5402_specific_output = value

    @property
    def payment_product5500_specific_output(self):
        """
    ...
    def payment_product5500_specific_output(self, value):
