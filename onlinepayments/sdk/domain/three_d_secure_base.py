...
class ThreeDSecureBase(DataObject):
    ...
    def decoupled_indicator(self, value):
        self.__decoupled_indicator = value

    @property
    def decoupled_max_time(self):
        """
    ...
    def decoupled_max_time(self, value):
    ...
    def merchant_fraud_rate(self, value):
        self.__merchant_fraud_rate = value

    @property
    def payment_token_source(self):
        """
    ...
    def payment_token_source(self, value):
    ...
    @property
    def secure_corporate_payment(self):
        """
    ...
    def secure_corporate_payment(self, value):
    ...
    def skip_soft_decline(self, value):
        self.__skip_soft_decline = value

    @property
    def three_ri_indicator(self):
        """
    ...
    def three_ri_indicator(self, value):
