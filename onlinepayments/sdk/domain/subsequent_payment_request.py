...
class SubsequentPaymentRequest(DataObject):
    ...
    @property
    def subsequent_payment_product5001_specific_input(self):
        """
    ...
    def subsequent_payment_product5001_specific_input(self, value):
        self.__subsequent_payment_product5001_specific_input = value

    @property
    def subsequentcard_payment_method_specific_input(self):
        """
    ...
    def subsequentcard_payment_method_specific_input(self, value):
