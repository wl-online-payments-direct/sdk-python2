...
class PaymentProduct3012SpecificInput(DataObject):
    ...
    def force_authentication(self, value):
        self.__force_authentication = value

    @property
    def is_deferred_payment(self):
        """
    ...
    def is_deferred_payment(self, value):
        self.__is_deferred_payment = value

    @property
    def is_wip_transaction(self):
        """
    ...
    def is_wip_transaction(self, value):
        self.__is_wip_transaction = value

    @property
    def wip_merchant_authentication_method(self):
        """
    ...
    def wip_merchant_authentication_method(self, value):
