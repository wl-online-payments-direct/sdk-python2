...
from ingenico.direct.sdk.domain.payment_product_field_form_element import PaymentProductFieldFormElement
from ingenico.direct.sdk.domain.payment_product_field_tooltip import PaymentProductFieldTooltip
...
class PaymentProductFieldDisplayHints(DataObject):
    ...
    def form_element(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product_field_form_element.PaymentProductFieldFormElement`
        """
    ...
    def tooltip(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product_field_tooltip.PaymentProductFieldTooltip`
        """
