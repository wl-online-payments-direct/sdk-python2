...
from ingenico.direct.sdk.domain.contact_details import ContactDetails
from ingenico.direct.sdk.domain.customer_account import CustomerAccount
from ingenico.direct.sdk.domain.customer_device import CustomerDevice
from ingenico.direct.sdk.domain.personal_information import PersonalInformation
...
class Customer(DataObject):
    ...
    def account(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.customer_account.CustomerAccount`
        """
    ...
    def contact_details(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.contact_details.ContactDetails`
        """
    ...
    def device(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.customer_device.CustomerDevice`
        """
    ...
    def personal_information(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.personal_information.PersonalInformation`
        """
