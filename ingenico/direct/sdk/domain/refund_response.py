...
from ingenico.direct.sdk.domain.order_status_output import OrderStatusOutput
from ingenico.direct.sdk.domain.refund_output import RefundOutput
...
class RefundResponse(DataObject):
    ...
    def refund_output(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.refund_output.RefundOutput`
        """
    ...
    def status_output(self):
        """
        Type: :class:`ingenico.direct.sdk.domain.order_status_output.OrderStatusOutput`
        """
