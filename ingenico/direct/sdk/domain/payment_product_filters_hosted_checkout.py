...
from ingenico.direct.sdk.domain.payment_product_filter import PaymentProductFilter
...
class PaymentProductFiltersHostedCheckout(DataObject):
    ...
    def exclude(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product_filter.PaymentProductFilter`
        """
