...
from ingenico.direct.sdk.domain.line_item_invoice_data import LineItemInvoiceData
from ingenico.direct.sdk.domain.order_line_details import OrderLineDetails
...
class LineItem(DataObject):
    ...
    def invoice_data(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.line_item_invoice_data.LineItemInvoiceData`
        """
    ...
    def order_line_details(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.order_line_details.OrderLineDetails`
        """
