...
from ingenico.direct.sdk.domain.refund_payment_product840_customer_account import RefundPaymentProduct840CustomerAccount
...
class RefundPaymentProduct840SpecificOutput(DataObject):
    ...
    def customer_account(self):
        """
        Type: :class:`ingenico.direct.sdk.domain.refund_payment_product840_customer_account.RefundPaymentProduct840CustomerAccount`
        """
