...
from ingenico.direct.sdk.domain.g_pay_three_d_secure import GPayThreeDSecure
...
class MobilePaymentProduct320SpecificInput(DataObject):
    ...
    def three_d_secure(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.g_pay_three_d_secure.GPayThreeDSecure`
        """
