...
from ingenico.direct.sdk.domain.mobile_payment_data import MobilePaymentData
...
class MobilePaymentMethodSpecificOutput(DataObject):
    ...
    def payment_data(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.mobile_payment_data.MobilePaymentData`
        """
