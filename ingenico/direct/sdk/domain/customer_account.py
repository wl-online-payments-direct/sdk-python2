...
from ingenico.direct.sdk.domain.customer_account_authentication import CustomerAccountAuthentication
from ingenico.direct.sdk.domain.customer_payment_activity import CustomerPaymentActivity
from ingenico.direct.sdk.domain.payment_account_on_file import PaymentAccountOnFile
...
class CustomerAccount(DataObject):
    ...
    def authentication(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.customer_account_authentication.CustomerAccountAuthentication`
        """
    ...
    def payment_account_on_file(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_account_on_file.PaymentAccountOnFile`
        """
    ...
    def payment_activity(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.customer_payment_activity.CustomerPaymentActivity`
        """
