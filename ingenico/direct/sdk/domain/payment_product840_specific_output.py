...
from ingenico.direct.sdk.domain.payment_product840_customer_account import PaymentProduct840CustomerAccount
from ingenico.direct.sdk.domain.protection_eligibility import ProtectionEligibility
...
class PaymentProduct840SpecificOutput(DataObject):
    ...
    def customer_account(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product840_customer_account.PaymentProduct840CustomerAccount`
        """
    ...
    def protection_eligibility(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.protection_eligibility.ProtectionEligibility`
        """
