...
from ingenico.direct.sdk.domain.payment_product_field_data_restrictions import PaymentProductFieldDataRestrictions
from ingenico.direct.sdk.domain.payment_product_field_display_hints import PaymentProductFieldDisplayHints
...
class PaymentProductField(DataObject):
    ...
    def data_restrictions(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product_field_data_restrictions.PaymentProductFieldDataRestrictions`
        """
    ...
    def display_hints(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.payment_product_field_display_hints.PaymentProductFieldDisplayHints`
        """
