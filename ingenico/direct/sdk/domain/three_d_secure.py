...
from ingenico.direct.sdk.domain.external_cardholder_authentication_data import ExternalCardholderAuthenticationData
...
class ThreeDSecure(DataObject):
    ...
    def external_cardholder_authentication_data(self):
        ...
        Type: :class:`ingenico.direct.sdk.domain.external_cardholder_authentication_data.ExternalCardholderAuthenticationData`
        """
