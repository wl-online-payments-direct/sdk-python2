...
project = u'onlinepayments-sdk-python2'
copyright = u'Copyright (c) 2020 Global Collect Services B.V.'
author = u'Online Payments'
...
#
# html_title = u'Python SDK v4.15.0'
...
htmlhelp_basename = 'onlinepayments-sdk-python2doc'
...
latex_documents = [
    (master_doc, 'onlinepayments-sdk-python2.tex', u'onlinepayments-sdk-python2 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'onlinepayments-sdk-python2', u'onlinepayments-sdk-python2 Documentation',
     [author], 1)
]
