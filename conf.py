...
#
# html_title = u'Python SDK v1.10.0'
...
htmlhelp_basename = 'direct-sdk-python2doc'
...
latex_documents = [
    (master_doc, 'direct-sdk-python2.tex', u'direct-sdk-python2 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'direct-sdk-python2', u'direct-sdk-python2 Documentation',
     [author], 1)
]
