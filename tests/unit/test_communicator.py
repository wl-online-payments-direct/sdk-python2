...
class CommunicatorTest(unittest.TestCase):
    ...
    def test_to_uri_without_request_parameters(self):
        ...
        communicator = Communicator(
            api_endpoint=urlparse("https://payment.preprod.direct.ingenico.com"),
        ...
        self.assertEqual("https://payment.preprod.direct.ingenico.com/v2/merchant/1/testconnection", uri1.geturl())
        self.assertEqual("https://payment.preprod.direct.ingenico.com/v2/merchant/1/testconnection", uri2.geturl())
    ...
    def test_to_uri_with_request_parameters(self):
        ...
        requestParams = [RequestParam("amount", "123"), RequestParam("source", "USD"), RequestParam("target", "EUR"), RequestParam("dummy", "é&%=")]
        communicator = Communicator(
            api_endpoint=urlparse("https://payment.preprod.direct.ingenico.com"),
            authenticator=DefaultAuthenticator("a_key", "a_secret"),
            meta_data_provider=MetaDataProvider("Ingenico"))
        ...
        self.assertEqual("https://payment.preprod.direct.ingenico.com/v2/1/testconnection"
