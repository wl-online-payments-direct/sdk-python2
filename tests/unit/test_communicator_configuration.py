...
class CommunicatorConfigurationTest(unittest.TestCase):
    ...
    def test_reject_unknown_authorization_type_in_config(self):
        """Tests if the default authenticator throws an exception if an invalid authorization type is provided in config."""
    ...
    def test_reject_unknown_authorization_type_in_param(self):
        """Tests if the default authenticator throws an exception if an invalid authorization type is provided as parameter."""
